...
for i in range(0, number_of_strips):#node_point_x[len(node_point_x) - 1]):
    ...
    angle_text_position_y = perpendicular_line_y_point_1 - 0.5
    ...
    ax.text(angle_text_position_x, angle_text_position_y, str(angle) + u'\N{DEGREE SIGN}', fontsize=8)
...
save_array = slot_x_coordinates_save, slot_y_coordinates_save, slot_arc_length_centers_save, slot_center_periodicities_save, slot_start_x_coordinates_save, slot_start_y_coordinates_save
